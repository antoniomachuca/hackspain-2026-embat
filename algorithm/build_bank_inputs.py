...
from algorithm.bank_panels import export_bank_inputs, fill_expense_splits
from algorithm.score_data import load_bank_panel
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'algorithm' / 'engine_results' / 'bank_inputs.npz')
