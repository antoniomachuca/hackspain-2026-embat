...
from algorithm.levers_catalog import PUBLIC_LEVER_IDS
from algorithm.levers_gates import evaluate_catalog, is_applicable
...
def test_prior_blocks_all(monkeypatch):
    from algorithm import levers_gates as g
