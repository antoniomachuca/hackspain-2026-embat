...
Run: python -m algorithm.episodes_report
...
from algorithm.bank_panels import SCORE_FIELDS, load_bank_inputs
from algorithm.levers_objects import OBJECTS_PATH, ap_pending_vector
from algorithm.score_episodes import build_episodes, month_diff
