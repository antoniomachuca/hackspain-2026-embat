...
from algorithm.score_data import month_edges, sha256
from algorithm.score_monitor import SnapshotNotReady, build_alert_history, load_completed_snapshot, monitor_once
from algorithm.score_states import StateConfig, classify_states
from algorithm.test_score_states import state_fixture
...
class MonitorTests(unittest.TestCase):
    ...
    def test_panel_replaced_during_read_is_rejected(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            with patch('algorithm.score_monitor.sha256', side_effect=[manifest_hash, panel_hash, manifest_hash, 'replacement']):
