...
from algorithm.score_data import add_cash_observations, load_bank_panel, load_erp_snapshot, sha256
from algorithm.score_engine import ScoreConfig, calculate_scores
from algorithm.score_monitor import atomic_json, monitor_once
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'algorithm' / 'engine_results')
