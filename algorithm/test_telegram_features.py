...
from algorithm.telegram_notifier import (
...
from algorithm.score_whatif import (
    simulate_whatif,
...
from algorithm.score_telegram_bot import (
    parse_amount,
...
class TestTelegramFeatures(unittest.TestCase):
    ...
    @patch('algorithm.score_telegram_bot.send_chat_action')
    @patch('algorithm.score_telegram_bot.add_subscriber')
    @patch('algorithm.score_telegram_bot.handle_chart_query')
    ...
    @patch('algorithm.score_telegram_bot.send_chat_action')
    @patch('algorithm.score_telegram_bot.add_subscriber')
    @patch('algorithm.score_telegram_bot.handle_whatif_query')
    @patch('algorithm.score_telegram_bot.answer_callback_query')
    ...
    @patch('algorithm.score_telegram_bot.send_chat_action')
    @patch('algorithm.score_telegram_bot.add_subscriber')
    @patch('algorithm.score_telegram_bot.handle_score_query')
    @patch('algorithm.score_telegram_bot.answer_callback_query')
