...
from algorithm.levers_objects import INVOICES_PATH, build_lever_objects
...
def main():
    ...
    parser.add_argument(
        '--output',
        type=Path,
        default=ROOT / 'algorithm' / 'engine_results' / 'lever_objects.npz',
    )
    ...
    if path.resolve() == (ROOT / 'algorithm' / 'engine_results' / 'lever_objects.npz').resolve():
