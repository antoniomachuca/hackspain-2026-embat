\section*{11. Resultados reproducibles del motor}
...
Sociedades con evidencia utilizable & 1170 & 1175 \\
Priors neutrales marcados & 116 & 111 \\
Calidad bancaria al menos 0,8 & 428 & 428 \\
Observaciones reales de caja & 0 & 0 \\
Enriquecimientos ERP usados & 0 & 466 \\
HHI utilizable & 125 & 513 \\
\hline
\end{tabular}
\end{center}

Se entregan 30864 filas empresa-mes en cada modo. Los priors no son diagnósticos de salud observada. No se calculó liquidez histórica real en estas ejecuciones: la caja conocida es cero observaciones, no un saldo imputado de cero. El núcleo usa cobertura de flujos. El snapshot ERP de 2026-09-01 aprovecha 466 sociedades; no se retropropaga a los meses anteriores.

\subsection*{11.2. Gates ejecutados}
...
\subsection*{11.3. Correlaciones de Spearman}
...
Banco & $L$ & $C$ & $D$ & $F$ \\
\hline
$L$ & 1,000 & 0,196 & 0,068 & 0,244 \\
$C$ & 0,196 & 1,000 & -0,153 & 0,437 \\
$D$ & 0,068 & -0,153 & 1,000 & -0,075 \\
$F$ & 0,244 & 0,437 & -0,075 & 1,000 \\
\hline
\end{tabular}
\end{center}
...
\hline
Corte final, sociedades con evidencia & 0,437 & 0,332 \\
Corte final, calidad bancaria alta & 0,259 & 0,258 \\
Peor corte maduro, sociedades con evidencia & 0,560 & 0,560 \\
Peor corte maduro, calidad bancaria alta & 0,399 & 0,399 \\
\hline
\end{tabular}
\end{center}

La matriz bancaria final utiliza 1170 sociedades; la subcohorte de calidad alta, 428. Se comprueban 19 cortes tras el calentamiento. Cumplir el umbral satisface un control de no redundancia extrema en esta muestra; no demuestra señal predictiva independiente.

\subsection*{11.4. Distribución y saturación}
